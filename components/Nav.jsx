    ...
    <>
      <div className="bg-navy text-white text-xs py-2 overflow-hidden whitespace-nowrap">
        <div className="flex gap-10 animate-marquee px-4">
          {['✓ One-time payment no subscription','7 Packages · 38 Courses · 140 Lessons','Real-world and online safety education','Family progress tracking included','🔒 Secure checkout via Stripe'].map((t, i) => (
