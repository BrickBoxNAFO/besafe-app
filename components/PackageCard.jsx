  ...
  return (
    <div className={`bg-white rounded-2xl p-6 border card-lift cursor-pointer ${owned ? 'border-teal/30 ring-1 ring-teal/20' : 'border-gray-100'}`}>
      ...
      <div className="flex flex-wrap gap-2 mb-5">
        ...
        {pkg.isGrowingBundle && <span className="chip text-xs px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 border border-amber-200/60">🎵 72 Songs In Lessons</span>}
      </div>
