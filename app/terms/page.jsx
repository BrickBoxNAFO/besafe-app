    ...
    <div className="page-enter max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="prose text-navy/70 leading-relaxed space-y-8">
        {[
          ...
          { h: '5. Intellectual Property', p: 'All course content, materials, and resources provided by HomeSafeEducation are protected by copyright. You may not copy, reproduce, distribute, or create derivative works from our content without prior written permission.' },
          ...
          { h: '8. Limitation of Liability', p: 'To the maximum extent permitted by law, HomeSafeEducation shall not be liable for any indirect, incidental, or consequential damages arising from your use of our services or reliance on our content.' },
