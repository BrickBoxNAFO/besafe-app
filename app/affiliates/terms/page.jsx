  ...
  return (
    <div className="page-enter max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="prose text-navy/70 leading-relaxed space-y-10">
        ...
        <div>
          <h2 className="font-semibold text-navy text-xl mb-3">14. Pricing and commission disclaimer</h2>
          <p className="text-sm">
            Product pricing may change over time and promotional offers may be introduced from time to time. Commission amounts shown in any marketing materials or guides are based on pricing at the time of publication and are provided as examples only. Your commission rate will always remain 20% of the amount actually taken from the sale, regardless of any price changes or promotions. This means that whatever the customer pays, you earn 20% of that amount.
          </p>
        </div>
