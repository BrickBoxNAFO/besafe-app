              ...
              <div className="max-w-lg w-full text-center">
                {/* Success Icon */}
                      <div className="mb-8">
                                ...
                                <h1 className="text-4xl font-bold text-navy-dark font-serif mb-2">Purchase Successful!</h1>h1>
                                <p className="text-lg text-gray-600">Your music purchase is ready to download.</p>p>
                      </div>div>
                ...
                {/* Footer Help */}
                      <div className="space-y-2 text-sm text-gray-600">
                                ...
                                <p>Check your email for a download link sent to your inbox.</p>p>
                      </div>div>
              </div>div>
        </main>main>
      );
