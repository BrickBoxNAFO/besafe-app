...
export async function POST(request) {
  try {
    ...
    if (seatId) {
      ...
      if ((existingSeats || []).length >= seatLimit) return NextResponse.json({ error: 'You have reached your seat limit of ' + seatLimit + '. Purchase additional seats to add more members.' }, { status: 400 })
