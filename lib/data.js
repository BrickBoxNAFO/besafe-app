...
const PACKAGES = [
  ...
  { id: 'street', name: 'Street Smart', emoji: '🛡️', color: '#DC2626', pale: 'rgba(220,38,38,0.10)', tag: 'Teenagers 12-17', tagline: 'Real-world safety skills for teenagers navigating an increasingly complex world.', desc: 'Four essential courses covering personal safety, online safety, healthy relationships, and peer pressure giving teenagers the knowledge and confidence to stay safe.', subjects: 4, lessons: 12, quizQs: 60 },
    {
    id: 'street',
    name: 'Street Smart',
    emoji: '🛡️',
...
const COURSES = [
  ...
  },
  {
    ...
    pkgName: 'Growing Minds', subPkgName: 'Junior', color: '#15803D', pale: 'rgba(21,128,61,0.10)', emoji: '🌿',
    lessons: ['What is Bullying Really?', 'What To Do if You Are Being Bullied', 'Being an Upstander and Your Own Behaviour'],
  },
  {
  ...
  // ── Nest Breaking ──
    {
    id: 'c31',
    title: 'Personal Safety and Awareness',
    pkg: 'street',
    pkgName: 'Street Smart',
    color: '#DC2626',
    pale: 'rgba(220,38,38,0.10)',
    emoji: '🛡️',
    lessons: ['Boundaries and Instinct', 'If Someone Is Following You', 'De-escalation and Staying Safe in Public'],
  },
  {
    id: 'c32',
    ...
    pale: 'rgba(220,38,38,0.10)',
    emoji: '🛡️',
    lessons: ['Your Digital Footprint and Privacy', 'Online Grooming, Manipulation and Harassment', 'Image Sharing, Pressure and the Law'],
  },
  {
    id: 'c33',
    ...
    pale: 'rgba(220,38,38,0.10)',
    emoji: '🛡️',
    lessons: ['Healthy vs Unhealthy Relationships', 'Consent and Boundaries', 'When and How to Get Help'],
  },
  {
    id: 'c34',
    ...
    pale: 'rgba(220,38,38,0.10)',
    emoji: '🛡️',
    lessons: ['Peer Pressure and Saying No', 'Substances: What You Need to Know', 'Recognising When Someone Needs Help'],
  },
