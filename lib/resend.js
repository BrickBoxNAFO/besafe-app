...
function musicUpsellBlock(musicCollectionName, songCount) {
  ...
  return `
    <div style="background:linear-gradient(135deg,#0B1F3A,#1a2f4a);border-radius:12px;padding:28px;margin:28px 0;">
      ...
      <p style="color:#CBD5E1;font-size:14px;line-height:1.7;margin:0 0 20px;"><strong style="color:#ffffff;">${songCount} educational songs</strong> packed with important safety knowledge — designed to help children feel confident, stay safe, and remember what matters most. Perfect for the car, the kitchen, bedtime — learning never stops.</p>
