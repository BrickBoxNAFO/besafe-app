...
function musicUpsellBlock(musicCollectionName, songCount) {
  ...
  return `
    <div style="background:linear-gradient(135deg,#0B1F3A,#1a2f4a);border-radius:12px;padding:24px;margin:28px 0;">
      <p style="color:#F59E0B;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;margin:0 0 8px;">🎵 EXCLUSIVE OFFER</p>
      <p style="color:#ffffff;font-size:18px;font-weight:700;margin:0 0 8px;">Did Your Family Love the Music?</p>
      <p style="color:#CBD5E1;font-size:14px;line-height:1.6;margin:0 0 16px;">Every lesson in <strong style="color:#ffffff;">${musicCollectionName}</strong> was paired with an original song. Download all <strong style="color:#ffffff;">${songCount} tracks</strong> to keep forever — perfect for reinforcing what they've learned, in the car, at home, or on the go.</p>
      <div style="text-align:center;">
        <a href="${SITE}/library" style="display:inline-block;background:#F59E0B;color:#0B1F3A;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;">Download the Song Collection →</a>
      </div>
    </div>`
}
