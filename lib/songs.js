...
Grown-ups' things stay in their place.`
  ...
  'c31': {
    lessons: [
      { title: 'Boundaries and Instinct', file: 'Street Smart/Course 1/Neon No-Signs.mp3', lyrics: '' },
      { title: 'If Someone Is Following You', file: 'Street Smart/Course 1/If Someone Is Following You.mp3', lyrics: '' },
      { title: 'De-escalation and Staying Safe in Public', file: 'Street Smart/Course 1/De-escalation and Staying Safe in Public.mp3', lyrics: '' },
      { title: 'Staying Safe at Night and in Unfamiliar Places', file: 'Street Smart/Course 1/Staying Safe at Night and in Unfamiliar Places.mp3', lyrics: '' },
    ],
    remember: { title: 'Remember This Course 1', file: 'Street Smart/Course 1/Remember this course 1.mp3', lyrics: '' }
  },

  // ─── Street Smart: Online Safety and Social Media (c32) ───
  'c32': {
    lessons: [
      { title: 'Your Digital Footprint and Privacy', file: 'Street Smart/Course 2/Your Digital Footprint and Privacy.mp3', lyrics: '' },
      { title: 'Online Grooming, Manipulation and Harassment', file: 'Street Smart/Course 2/Online Grooming, Manipulation and Harassment.mp3', lyrics: '' },
      { title: 'Image Sharing, Pressure and the Law', file: 'Street Smart/Course 2/Image Sharing, Pressure and the Law.mp3', lyrics: '' },
      { title: 'Scams, Catfishing and Fake Profiles', file: 'Street Smart/Course 2/Scams, Catfishing and Fake Profiles.mp3', lyrics: '' },
    ],
    remember: { title: 'Remember This Course 2', file: 'Street Smart/Course 2/Remember This Course 2.mp3', lyrics: '' }
  },

  // ─── Street Smart: Healthy Relationships and Boundaries (c33) ───
  'c33': {
    lessons: [
      { title: 'Healthy vs Unhealthy Relationships', file: 'Street Smart/Course 3/Healthy vs Unhealthy Relationships.mp3', lyrics: '' },
      { title: 'Consent and Boundaries', file: 'Street Smart/Course 3/Consent and Boundaries.mp3', lyrics: '' },
      { title: 'When and How to Get Help', file: 'Street Smart/Course 3/When and How to Get Help.mp3', lyrics: '' },
      { title: 'Toxic Friendships and Social Dynamics', file: 'Street Smart/Course 3/Toxic Friendships and Social Dynamics.mp3', lyrics: '' },
    ],
    remember: { title: 'Remember This Course 3', file: 'Street Smart/Course 3/Remember This Course 3.mp3', lyrics: '' }
  },

  // ─── Street Smart: Peer Pressure and Substance Awareness (c34) ───
  'c34': {
    lessons: [
      { title: 'Peer Pressure and Saying No', file: 'Street Smart/Course 4/Peer Pressure and Saying No.mp3', lyrics: '' },
      { title: 'Substances: What You Need to Know', file: 'Street Smart/Course 4/Substances_ What You Need to Know.mp3', lyrics: '' },
      { title: 'Recognising When Someone Needs Help', file: 'Street Smart/Course 4/Recognising When Someone Needs Help.mp3', lyrics: '' },
      { title: 'Parties, Events and Staying Safe', file: 'Street Smart/Course 4/Parties, Events and Staying Safe.mp3', lyrics: '' },
    ],
    remember: { title: 'Remember This Course 4', file: 'Street Smart/Course 4/Remember This Course 4.mp3', lyrics: '' }
  },

  // ─── Street Smart: Mental Health and Emotional Wellbeing (c37) ───
  'c37': {
    lessons: [
      { title: 'Understanding Mental Health', file: 'Street Smart/Course 5/Understanding Mental Health.mp3', lyrics: '' },
      { title: 'Anxiety and Depression', file: 'Street Smart/Course 5/Anxiety and Depression.mp3', lyrics: '' },
      { title: 'Self-Harm, Crisis and Getting Help', file: 'Street Smart/Course 5/Self-Harm, Crisis and Getting Help.mp3', lyrics: '' },
      { title: 'Looking After Your Mental Health', file: 'Street Smart/Course 5/Looking After Your Mental Health.mp3', lyrics: '' },
    ],
    remember: { title: 'Remember This Course 5', file: 'Street Smart/Course 5/Remember This Course 4.mp3', lyrics: '' }
  },

  // ─── Street Smart: Weapons Awareness (c38) ───
  'c38': {
    lessons: [
      { title: 'Understanding Weapon Violence', file: 'Street Smart/Course 6/Understanding Weapon Violence.mp3', lyrics: '' },
      { title: 'How People Get Drawn In', file: 'Street Smart/Course 6/How People Get Drawn In.mp3', lyrics: '' },
      { title: 'What to Do If You Are Confronted', file: 'Street Smart/Course 6/What to Do If You Are Confronted.mp3', lyrics: '' },
      { title: 'Choosing a Different Path', file: 'Street Smart/Course 6/Choosing a Different Path.mp3', lyrics: '' },
    ],
    remember: { title: 'Remember This Course 6', file: 'Street Smart/Course 6/Remember this Course 6.mp3', lyrics: '' }
  },
};
